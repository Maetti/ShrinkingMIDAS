...
#include "stanExports_horseshoe_group_plus.h"

RCPP_MODULE(stan_fit4horseshoe_group_plus_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_horseshoe_group_plus")

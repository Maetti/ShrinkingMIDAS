...
#include "stanExports_horseshoe_plus_wo_group.h"

RCPP_MODULE(stan_fit4horseshoe_plus_wo_group_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_horseshoe_plus_wo_group")

...
namespace model_horseshoe_group_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_horseshoe_group");
    reader.add_event(83, 81, "end", "model_horseshoe_group");
    return reader;
}
#include <stan_meta_header.hpp>
class model_horseshoe_group
  : public stan::model::model_base_crtp<model_horseshoe_group> {
private:
        int nY_train;
        int nY_test;
        int nZ;
        ...
        vector_d pr_sigma;
public:
    model_horseshoe_group(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_horseshoe_group_namespace::model_horseshoe_group";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_horseshoe_group_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_horseshoe_group_namespace::model_horseshoe_group stan_model;
#ifndef USING_R

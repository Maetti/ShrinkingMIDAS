...
#include "stanExports_horseshoe_group.h"

RCPP_MODULE(stan_fit4horseshoe_group_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_horseshoe_group")

...
namespace model_horseshoe_plus_wo_group_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_horseshoe_plus_wo_group");
    reader.add_event(70, 68, "end", "model_horseshoe_plus_wo_group");
    return reader;
}
#include <stan_meta_header.hpp>
class model_horseshoe_plus_wo_group
  : public stan::model::model_base_crtp<model_horseshoe_plus_wo_group> {
private:
        int nY_train;
        int nY_test;
        int nZ;
        ...
        vector_d pr_sigma;
public:
    model_horseshoe_plus_wo_group(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_horseshoe_plus_wo_group_namespace::model_horseshoe_plus_wo_group";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "y_train", "vector_d", context__.to_vec(nY_train));
            y_train = Eigen::Matrix<double, Eigen::Dynamic, 1>(nY_train);
            vals_r__ = context__.vals_r("y_train");
            pos__ = 0;
            size_t y_train_j_1_max__ = nY_train;
            for (size_t j_1__ = 0; j_1__ < y_train_j_1_max__; ++j_1__) {
                y_train(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 14;
            validate_non_negative_index("y_test", "nY_test", nY_test);
            context__.validate_dims("data initialization", "y_test", "vector_d", context__.to_vec(nY_test));
            y_test = Eigen::Matrix<double, Eigen::Dynamic, 1>(nY_test);
            vals_r__ = context__.vals_r("y_test");
            pos__ = 0;
            size_t y_test_j_1_max__ = nY_test;
            for (size_t j_1__ = 0; j_1__ < y_test_j_1_max__; ++j_1__) {
                y_test(j_1__) = vals_r__[pos__++];
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(cauchy_log<propto__>(lambda, 0, tau));
            current_statement_begin__ = 51;
            lp_accum__.add(normal_log<propto__>(theta, 0, (sigma * lambda)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_horseshoe_plus_wo_group_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_horseshoe_plus_wo_group";
    }
...
typedef model_horseshoe_plus_wo_group_namespace::model_horseshoe_plus_wo_group stan_model;
#ifndef USING_R

...
namespace model_group_lasso_hierarchical_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_group_lasso_hierarchical");
    reader.add_event(79, 77, "end", "model_group_lasso_hierarchical");
    return reader;
}
#include <stan_meta_header.hpp>
class model_group_lasso_hierarchical
  : public stan::model::model_base_crtp<model_group_lasso_hierarchical> {
private:
        int nY_train;
        int nY_test;
        int nZ;
        ...
        vector_d pr_sigma;
public:
    model_group_lasso_hierarchical(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_group_lasso_hierarchical_namespace::model_group_lasso_hierarchical";
    ...
    ~model_group_lasso_hierarchical() { }
        ...
        try {
            ...
            for (int i = 1; i <= nZ; ++i) {
                ...
                stan::model::assign(tr_Sigma, 
                            ...
                            ((sigma2 * square(get_base1(lambda, i, "lambda", 1))) * square(get_base1(delta, get_base1(gInd, i, "gInd", 1), "delta", 1))), 
            ...
            lp_accum__.add(exponential_log<propto__>(delta, 1));
            current_statement_begin__ = 56;
            lp_accum__.add(exponential_log<propto__>(lambda, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_group_lasso_hierarchical_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_group_lasso_hierarchical";
    }
...
typedef model_group_lasso_hierarchical_namespace::model_group_lasso_hierarchical stan_model;
#ifndef USING_R

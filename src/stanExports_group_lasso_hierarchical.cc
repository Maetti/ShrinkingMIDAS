...
#include "stanExports_group_lasso_hierarchical.h"

RCPP_MODULE(stan_fit4group_lasso_hierarchical_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_group_lasso_hierarchical")
